...
getData(`chara/user/auction/1/1000`,function (d, s) {
	var chara = {};
	document.write('<table><tbody><tr><th>ID</th><th>角色</th><th>出价</th><th>数量</th></tr></tbody><tbody>');
	for(i=0;i<d.Value.Items.length; i++){
		...
		document.write('<tr><td><a href="https://bgm.tv/character/'+Id+'" class="l">'+Id+'</a></td><td>'+chara[Id].Name+'</td><td>'+chara[Id].Price+'</td><td>'+chara[Id].Amount+'</td></tr>');
	}
	//console.table(chara);
});
